...
/**
 * Description of API access logs Model
 * 
 * @category admin
 *            
 * @package tools
 ...
 * 
 * @class Api_access_logs_model.php
 * 
 * @path application\admin\tools\models\Api_access_logs_model.php
 * 
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Api_access_logs_model extends CI_Model 
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function __construct() 
    {
        ...
        $this->table_name = "api_accesslogs";
        $this->table_alias = "aa";
        ...
        $this->join_tables = array(
            array(
                ...
                "table_alias" => "u",
                "field_name" => "iUserId",
                "rel_table_name" => "api_accesslogs",
                "rel_table_alias" => "aa",
                "rel_field_name" => "iPerformedBy",
                "join_type" => "left",
                "extra_condition" => ""
            )
        );
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
                ...
                "align" => "left",
                "label" => "Email",
                "lang_code" => "API_ACCESS_LOGS_EMAIL",
                "label_lang" => $this->lang->line('API_ACCESS_LOGS_EMAIL'),
                "width" => 100,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "table_alias" => "aa",
                "field_name" => "vAPIURL",
                "source_field" => "aa_api_url",
                "display_query" => "aa.vAPIURL",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "API Url",
                "lang_code" => "API_ACCESS_LOGS_API_URL",
                "label_lang" => $this->lang->line('API_ACCESS_LOGS_API_URL'),
                "width" => 100,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "table_alias" => "aa",
                "field_name" => "vAPIName",
                "source_field" => "aa_request_uri",
                "display_query" => "aa.vAPIName",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                ...
                "table_name" => "api_accesslogs",
                "table_alias" => "aa",
                "field_name" => "vIPAddress",
                "source_field" => "aa_i_paddress",
                "display_query" => "aa.vIPAddress",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_in" => "Both",
                "type" => "textbox",
                "align" => "left",
                "label" => "IP Address",
                "lang_code" => "API_ACCESS_LOGS_IP_ADDRESS",
                "label_lang" => $this->lang->line('API_ACCESS_LOGS_IP_ADDRESS'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "table_name" => "api_accesslogs",
                "table_alias" => "aa",
                "field_name" => "dAccessDate",
                "source_field" => "aa_access_date",
                "display_query" => "aa.dAccessDate",
                "entry_type" => "Table",
                "data_type" => "datetime",
                "show_in" => "Both",
                "type" => "date",
                ...
                "align" => "left",
                "label" => "Input Params",
                "lang_code" => "API_ACCESS_LOGS_INPUT_PARAMS",
                "label_lang" => $this->lang->line('API_ACCESS_LOGS_INPUT_PARAMS'),
                "width" => 50,
                "search" => "No",
                "export" => "Yes",
                "sortable" => "No",
                ...
                "editable" => "No",
                "viewedit" => "No",
                "php_func" => "controller::showInputParamsLink"
            ),
                ...
                "lang_code" => "API_ACCESS_LOGS_OUTPUT_RESPONSE",
                "label_lang" => $this->lang->line('API_ACCESS_LOGS_OUTPUT_RESPONSE'),
                "width" => 50,
                "search" => "No",
                "export" => "Yes",
                "sortable" => "No",
                ...
                "editable" => "No",
                "viewedit" => "No",
                "php_func" => "controller::showInputResponseLink"
            ),
                "aa_performed_by" => array(
                "name" => "aa_performed_by",
                "table_name" => "api_accesslogs",
                "table_alias" => "aa",
                "field_name" => "iPerformedBy",
                "source_field" => "aa_performed_by",
                "display_query" => "aa.iPerformedBy",
                "entry_type" => "Table",
                "data_type" => "int",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "Performed By",
                "lang_code" => "API_ACCESS_LOGS_PERFORMED_BY",
                "label_lang" => $this->lang->line('API_ACCESS_LOGS_PERFORMED_BY'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
                ...
                "type" => "textbox",
                "label" => "I Paddress",
                "lang_code" => "API_ACCESS_LOGS_I_PADDRESS",
                "label_lang" => $this->lang->line('API_ACCESS_LOGS_I_PADDRESS')
            ),
                "aa_file_name" => array(
                "name" => "aa_file_name",
                "table_name" => "api_accesslogs",
                "table_alias" => "aa",
                "field_name" => "vFileName",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "File Name",
                "lang_code" => "API_ACCESS_LOGS_FILE_NAME",
                "label_lang" => $this->lang->line('API_ACCESS_LOGS_FILE_NAME')
            ),
                "aa_executed_date" => array(
                "name" => "aa_executed_date",
                "table_name" => "api_accesslogs",
                "table_alias" => "aa",
                "field_name" => "dtExecutedDate",
                "entry_type" => "Table",
                "data_type" => "datetime",
                "show_input" => "Both",
                "type" => "date",
                "label" => "Executed Date",
                "lang_code" => "API_ACCESS_LOGS_EXECUTED_DATE",
                "label_lang" => $this->lang->line('API_ACCESS_LOGS_EXECUTED_DATE'),
                "format" => ''
            ),
                "aa_performed_by" => array(
                "name" => "aa_performed_by",
