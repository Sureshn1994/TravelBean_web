...
class Users_management extends Cit_Controller
{
        ...
        $this->dropdown_arr = array(
            ...
            "u_social_login_type" => array(
                ...
                "values" => array(
                    array(
                        'id' => 'facebook',
                        'val' => $this->lang->line('USERS_MANAGEMENT_FACEBOOK')
                    ),
                    array(
                        'id' => 'g+',
                        'val' => $this->lang->line('USERS_MANAGEMENT_G_C43')
                    )
                )
            ),
            "u_device_type" => array(
    ...
    public function addAction()
    {
        ...
        try
        {
            ...
            $u_social_login_type = $params_arr["u_social_login_type"];
            $u_social_login_id = $params_arr["u_social_login_id"];
            ...
            $data["eSocialLoginType"] = $u_social_login_type;
            ...
            $save_data_arr["u_social_login_type"] = $data["eSocialLoginType"];
