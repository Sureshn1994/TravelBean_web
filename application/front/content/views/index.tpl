                            ...
                            <div class="main-menu f-right d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">    
                                       ...
                                       <li><a href="mailto:reboundmobileapp@gmail.com">Contact</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-lg-6 col-md-9 ">
                                <div class="hero__caption">
                                    ...
                                    <h1 data-animation="fadeInUp" data-delay=".6s">Get Connected <br>with Travel Bean Mobile App</h1>
                                    <p data-animation="fadeInUp" data-delay=".8s">Personalize your travel experience and have all your finances in one place.</p>
                                    <!-- Slider btn -->
            ...
            <div class="slider-active">
                <div class="single-slider slider-height slider-padding sky-blue d-flex align-items-center">
                    <div class="container">
                        <div class="row d-flex align-items-center">
                             <div class="col-lg-6">
                                <div class="hero__img d-none d-lg-block f-left custom-about" data-animation="fadeInRight" data-delay="1s">
                            ...
                            <div class="col-lg-6 col-md-9 ">
                                <div class="hero__caption">
                                    ...
                                    <p data-animation="fadeInUp" data-delay=".8s">Keeping track of your spending abroad can be confusing and you may risk getting taken advantage of as a foreigner. With Travel Bean, you can ease your worries and have a seamless travel experience.</p>
                                    <!-- Slider btn -->
                                   <div class="slider-btns">
                                        <!-- Hero-btn -->
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="single-features mb-70">
                                    ...
                                    <div class="features-caption">
                                        <h3>Login</h3>
                                        <p>Create an account to log in and access your information stored safely within the app.</p>
                                    </div>
                                </div>
                            </div>
                             <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="single-features mb-70">
                                    ...
                                    <div class="features-caption">
                                    	 <h3>Settings</h3>
                                        <p>View and adjust your settings to your personal preferences.</p>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="single-features mb-70">
                                    ...
                                    <div class="features-caption">
                                       <h3>Create Lists</h3>
                                        <p>Make sure you paid the right amount by uploading grocery lists and their receipts to be converted with up-to-date conversions.
</p>
                                    </div>
                                </div>
                            </div>
                             <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="single-features mb-70">
                                    ...
                                    <div class="features-caption">
                                        ...
                                        <p>Get a better grasp on what you're spending abroad by having a currency converter at your fingertips.</p>
               ...
               <div class="row d-flex justify-content-center">
                    <div class="col-lg-6">
                        <div class="section-tittle text-center">
                            <h2>How Can We Help You<br>with Travel Bean!</h2>
                        </div>
                    </div>
                </div>
                <!-- Section caption -->
                <div class="row">
                    <div class="col-lg-6">
                        <div class=" text-center mb-30">
                           <div class="et_pb_code_inner"><iframe width="100%" height="315" src="https://www.youtube.com/embed/KI2cqssZGT0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-8">
                        <div class="single-cases-info mb-30">
                            <h3>Travel Bean App<br> Screenshots</h3>
                            <p>The All-In-One Travel App</p>
                        </div>
                    </div>
                    <!-- OwL -->
                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="app-caption">
                            <div class="section-tittle section-tittle3">
                                <h2>Travel Bean App Available for Any Device.</h2>
                                <p>Download Travel Bean today!</p>
                                <div class="app-btn">
            ...
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-xl-2 col-lg-3">
                        <div class="say-btn">
                            <a href="mailto:reboundmobileapp@gmail.com" class="btn radius-btn">Contact Us</a>
                        </div>
                    </div>
                </div>
            </div>
...
var scrollSrc = "<%$this->config->item('site_url')%>public/upload/website_images/logo/logo.png";
